...
"""
KALAVU: Pythia-1B Three-Domain Specialist Fusion Experiment
===========================================================
...
def step2_train_specialists(tokenizer, all_domain_chunks: dict, device: str) -> dict:
    ...
    print("\n[kalavu] pythia-1b step 2: specialists trained")
...
def step4_fusion(tokenizer, all_domain_chunks: dict, device: str,
    ...
    for seed in SEEDS:
        ...
        print(f"[kalavu] pythia-1b seed={seed}: improvement={improvement_pct:.1f}%")
...
def step5_final_summary(step1_result: dict, step3_results: dict,
    ...
    print(f"\n[kalavu] pythia-1b complete: mean={mean_imp:.1f}% std={std_imp:.1f}%")
...
def main():
    print("=" * 70)
    print("KALAVU: Pythia-1B Three-Domain Specialist Fusion Experiment")
    print("=" * 70)
