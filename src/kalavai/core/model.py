"""Minimal GPT-style transformer model compatible with Kalavai's ArchitectureConfig.
...
class KalavaiTransformerBlock(nn.Module):
...
class KalavaiModel(nn.Module):
    """GPT-style transformer model for Kalavai cooperative training.
    ...
    def __init__(
        ...
        self.layers = nn.ModuleList([
            KalavaiTransformerBlock(d_model, n_heads, ffn_ratio, norm)
...
def create_model_from_config(
    ...
    """Create a KalavaiModel from an ArchitectureConfig.
    ...
    Returns:
        An initialized KalavaiModel instance.
    """
    return KalavaiModel(
