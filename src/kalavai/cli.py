"""KALAVAI CLI — The Decentralized LLM Training Protocol."""
...
@click.group()
@click.version_option(version=__version__, prog_name="kalavai")
def main():
    """KALAVAI — 20 GPUs. 1 model. No one trains alone."""
