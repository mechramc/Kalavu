...
const phases = [
  { id: "create", label: "Create Cooperative", cmd: "kalavai coop create", actor: "Organizer", color: "#A78BFA" },
  { id: "train", label: "Train Module", cmd: "kalavai train start", actor: "Contributor", color: "#E8B931" },
  { id: "check", label: "Alignment Check", cmd: "kalavai check post", actor: "Automatic", color: "#4ECDC4" },
  { id: "fuse", label: "Fuse Model", cmd: "kalavai fuse build", actor: "Organizer", color: "#FF6B6B" },
];
...
const CreateDiagram = () => (
  <svg viewBox="0 0 700 320" style={{ width: "100%", height: "auto" }}>
    <text x={350} y={25} textAnchor="middle" fontSize={11} fill="#A78BFA" fontWeight={700} fontFamily="'JetBrains Mono', monospace">
      kalavai coop create --name "open-20b" --modules 20
    </text>
    ...
    <text x={350} y={265} textAnchor="middle" fontSize={8} fill="#888" fontFamily="'JetBrains Mono', monospace">kalavai.yaml \u00B7 tokenizer.model \u00B7 seed_checkpoint.pt \u00B7 calibration_batch.pt \u00B7 cka_reference.pt</text>
...
const CheckDiagram = () => (
  <svg viewBox="0 0 700 300" style={{ width: "100%", height: "auto" }}>
    ...
    <text x={350} y={220} textAnchor="middle" fontSize={10} fill="#4ECDC4" fontWeight={700} fontFamily="'JetBrains Mono', monospace">kalavai coop status open-20b</text>
...
const FuseDiagram = () => (
  <svg viewBox="0 0 700 330" style={{ width: "100%", height: "auto" }}>
    ...
    {/* Three steps */}
    {[
      { x: 40, label: "kalavai fuse cluster", sub: "Pairwise CKA \u2192\nautomated clustering\n\u2192 4 groups", color: "#FF6B6B" },
      { x: 265, label: "kalavai fuse build", sub: "Assemble fusion\narchitecture\n(MoE or XAttn)", color: "#E8B931" },
      { x: 490, label: "kalavai fuse train", sub: "Post-training\ncurriculum\n8-12% of pretrain cost", color: "#4ECDC4" },
    ].map((s, idx) => (
      <g key={idx}>
    ...
    {/* Distribution */}
    <text x={350} y={270} textAnchor="middle" fontSize={10} fill="#FF6B6B" fontWeight={600} fontFamily="'JetBrains Mono', monospace">kalavai coop publish open-20b</text>
...
export default function KALAVAIv3() {
  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: "center", marginBottom: 36 }}>
        ...
        <h1 style={{ fontSize: 32, fontWeight: 700, color: "#fff", margin: "4px 0" }}>KALAVAI</h1>
