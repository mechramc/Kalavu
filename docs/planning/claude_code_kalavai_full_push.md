# KALAVAI: The Full Push — All Remaining Experiments
...
6. Reuse data loading, eval functions, and tokenization from kalavai_pythia_experiment.py — do not rewrite these

## File Naming Convention (strict)

```
kalavai_pythia_maturity_sweep.py          # Experiment 1
kalavai_pythia_1b_experiment.py           # Experiment 2
kalavai_pythia_1b_maturity_sweep.py       # Experiment 3
kalavai_pythia_5domain_experiment.py      # Experiment 4
...
**Git commit after each checkpoint:** `[kalavai] maturity sweep 410m: step={STEP} improvement={X.X}%`
...
**Git commit:** `[kalavai] maturity sweep 410m: multi-seed on step={STEP1} and step={STEP2}`
...
**Git commit after each seed:** `[kalavai] pythia-1b seed={N}: improvement={X.X}%`
...
**Git commit after each checkpoint:** `[kalavai] 1b maturity sweep: step={STEP} improvement={X.X}%`
...
- Shaded region or annotation showing "KALAVAI's target regime" in the early-training zone
...
**Git commit after completion:** `[kalavai] 5-domain: 2/3/4/5 specialist scaling = {results}`
...
Overall figure title: "KALAVAI: Cooperative LLM Fusion — Key Results"
...
**Git commit:** `[kalavai] all experiments complete — hero figure generated`
...
```
KALAVAI COMPLETE EXPERIMENT INVENTORY
=====================================
...
**Final git commit:** `[kalavai] experiment campaign complete — ready for paper writing`
