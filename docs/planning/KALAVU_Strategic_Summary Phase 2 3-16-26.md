# KALAVU: Strategic Summary for Claude Code
...
**The issue:** Freeze=0 works (+14.85%). Frozen layers cost 0.7pp for no clear benefit. Is KALAVU really about frozen layers?
...
**The issue:** Qwen shows -1.0%. Does KALAVU only work on undertrained models?
...
- Fix `kalavu_pythia_6b_experiment.py` using the disk space fix prompt
...
- Descriptive commit messages: `[kalavu] experiment_name: key_result`
