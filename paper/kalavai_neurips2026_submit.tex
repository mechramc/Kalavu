...
Phase 2 extends the protocol to high-divergence settings: cross-lingual fusion (Tamil/Yoruba/Welsh/Code) achieves $+21.76\%$ on 2 of 3 seeds (seed 42 router collapse documented in Section~4.7; 3-seed mean $+16.55\%$), with Yoruba perplexity falling $41.9\to7.7$.
...
\begin{itemize}[leftmargin=*, itemsep=2pt]
  ...
  \item \textbf{High-divergence validation.} Phase 2 extends the protocol to private professional domains ($+10.17\%$, medical/legal/patent) and cross-lingual settings ($+21.76\%$ on 2 of 3 seeds, $+16.55\%$ 3-seed mean; Tamil/Yoruba/Welsh/Code; Yoruba perplexity $41.9\to7.7$; seed 42 router collapse documented in Section~4.7). Gain scales most steeply where the base model is least competent.
