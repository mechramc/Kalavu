"""
Synthetic experiment training loop for KALAVAI proof-of-concept.
...
Usage:
    python -m kalavai.train --config configs/synthetic/2mod_3M.yaml
    python -m kalavai.train --config configs/synthetic/2mod_3M.yaml --seed 42
"""
...
from kalavai.data import build_datasets, make_mixed_dataset, TextDataset
from kalavai.model import MiniGPT, ModelConfig, SimpleMoEFusion
...
def main():
    parser = argparse.ArgumentParser(description="Run synthetic KALAVAI experiment")
    ...
    print("=" * 70)
    print(f"KALAVAI Synthetic Experiment: {cfg.name}")
    print("=" * 70)
