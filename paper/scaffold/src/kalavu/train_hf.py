...
Usage:
    python -m kalavu.train_hf --config configs/real/qwen_2mod_math_science.yaml --seed 42
...
def main():
    parser = argparse.ArgumentParser(description="Train a KALAVU specialist module")
