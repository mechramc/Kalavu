...
"""
KALAVAI: Pythia-410M Base Model Maturity Sweep
==============================================
...
def run_checkpoint_seed(revision, step_n, training_pct, seed,
    ...
    print(f"[kalavai] maturity sweep 410m: step={step_n} improvement={improvement:.1f}%")
...
def main():
    print("=" * 70)
    print("KALAVAI: Pythia-410M Base Model Maturity Sweep")
    print("=" * 70)
    ...
    print("[kalavai] maturity sweep 410m: multi-seed complete")
    ...
    print(f"\n[kalavai] maturity sweep 410m: curve = [{improvements_str}]")
