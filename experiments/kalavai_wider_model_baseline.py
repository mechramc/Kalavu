...
"""
KALAVAI: Wider Model Baseline (Pythia-1.4B)
===========================================
...
def main():
    print("=" * 70)
    print("KALAVAI: Wider Model Baseline (Pythia-1.4B)")
    print("=" * 70)
    ...
    msg = (f"[kalavai] wider model baseline: 1.4B improvement={improvement_pct:.1f}% "
