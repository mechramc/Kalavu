...
"""
KALAVAI: Pythia-410M Five-Domain Specialist Fusion Experiment
============================================================
...
def main():
    print("=" * 70)
    print("KALAVAI: Pythia-410M Five-Domain Specialist Fusion Experiment")
    print("=" * 70)
    ...
    print(f"\n[kalavai] 5-domain: 2/3/4/5 specialist scaling = {scaling_str}")
