#!/usr/bin/env python3
"""
KALAVU: Qwen2.5-1.5B 5-Domain Specialist Fusion Experiment
===========================================================
...
EVAL_BATCHES = 50
SEED = 42
CHECKPOINT_DIR = Path("kalavu_checkpoints_5domain")
RESULTS_PATH = Path("kalavu_checkpoints_5domain/qwen_5domain_results.json")
...
def main():
    ...
    print("=" * 70)
    print("KALAVU: Qwen2.5-1.5B 5-Domain Fusion Experiment")
    print("=" * 70)
