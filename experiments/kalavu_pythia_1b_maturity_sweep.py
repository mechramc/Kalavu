...
"""
KALAVU: Pythia-1B Maturity Sweep
=================================
Trains specialists at 4 checkpoints (step5000, step20000, step50000, step143000)
and combines with step10000 results from kalavu_pythia_1b_experiment.py to
...
REVISIONS = [
    ("step5000",   5000,   3.5),
    # step10000 comes from kalavu_pythia_1b_experiment.py — reuse those checkpoints
...
def run_one_checkpoint(revision: str, training_pct: float, tokenizer,
    ...
    print(f"[kalavu] 1b maturity sweep: step={revision} improvement={improvement_pct:.1f}%")
...
def load_step10000_result() -> dict:
    ...
    if not MAIN_1B_RESULTS_PATH.exists():
        ...
        print("  Run kalavu_pythia_1b_experiment.py first, or set improvement_pct manually.")
        ...
        return {
            ...
            "source": "MISSING — run kalavu_pythia_1b_experiment.py first",
        }
...
def save_maturity_curve_combined(sweep_1b: list[dict], sweep_410m: list[dict]):
    ...
    Shaded KALAVU target regime (0-20%).
    ...
    try:
        ...
        # Shaded KALAVU target regime (early training zone 0-20%)
...
def main():
    print("=" * 70)
    print("KALAVU: Pythia-1B Maturity Sweep")
    print("=" * 70)
    ...
    print("\n[kalavu] 1b maturity sweep complete -- combined figure generated")
